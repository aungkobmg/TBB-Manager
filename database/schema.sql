...
CREATE TABLE IF NOT EXISTS `bales` (
  ...
  KEY `idx_bales_archived` (`archived_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Initialize product code sequence
INSERT INTO `sequences` (`name`, `current_value`) VALUES ('product_code', 0)
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  KEY `idx_customers_archived` (`archived_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `payment_received_amount` DECIMAL(12,2) NULL,
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  `cost_price_snapshot` DECIMAL(12,2) NOT NULL DEFAULT 0.00,
...
-- The installer script (install.php) will create the admin account
-- with a user-chosen secure password on first run.
-- ============================================================
